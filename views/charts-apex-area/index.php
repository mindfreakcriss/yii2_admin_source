<?php
$this->registerJsFile('/admin/js/pages/demo.apex-area.js', ['depends' => 'app\assets\\AdminAsset']);
?>
                                        ...
                                        <div dir="ltr">
                                            ...
                                            <div class="pt-2 pb-2">
                                                <div class="row align-items-center">
                                                    <div class="col-auto">
                                                        <img src="/admin/images/users/avatar-2.jpg" class="avatar-xs rounded" alt="file-image">
                                                    </div>
                                                    <div class="col ps-0">
