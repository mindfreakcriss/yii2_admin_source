                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-self-start">
                                            <img class="d-flex align-self-start rounded me-2" src="/admin/images/users/avatar-5.jpg" alt="Dominic Keller" height="48">
                            ...
                            <div class="col-xxl-6 col-lg-12 order-lg-2 order-xxl-1">
                                ...
                                <div class="card">
                                    <div class="card-body pb-1">
                                        <div class="d-flex">
                                            <img class="me-2 rounded" src="/admin/images/users/avatar-3.jpg" alt="Generic placeholder image" height="32">
                                            <div class="w-100">
                                        ...
                                        <div class="mt-3">
                                            <div class="d-flex">
                                                <img class="me-2 rounded" src="/admin/images/users/avatar-9.jpg" alt="Generic placeholder image" height="32">
                                                <div>
                                                    ...
                                                    <div class="d-flex mt-3">
                                                        <img class="me-2 rounded" src="/admin/images/users/avatar-8.jpg" alt="Generic placeholder image" height="32">
                                                        <div>
                                ...
                                <div class="card">
                                    <div class="card-body pb-1">
                                        <div class="d-flex">
                                            <img class="me-2 rounded" src="/admin/images/users/avatar-5.jpg" alt="Generic placeholder image" height="32">
                                            <div class="w-100">
                                                <div class="dropdown float-end text-muted">
                                                    <a href="#" class="dropdown-toggle arrow-none card-drop"
                                                        data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <div class="my-3">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    <img src="/admin/images/small/small-4.jpg" alt="post-img" class="rounded me-1 mb-3 mb-sm-0 img-fluid"/>
                                                </div>
                                                <div class="col">
                                                    <img src="/admin/images/small/small-2.jpg" alt="post-img" class="rounded me-1 img-fluid mb-3" />
                                                    <img src="/admin/images/small/small-3.jpg" alt="post-img" class="rounded me-1 img-fluid" />
                                                </div>
                                            </div>
                                        </div>
