<?php
$this->registerJsFile('/admin/js/pages/demo.dashboard-projects.js', ['depends' => 'app\assets\\AdminAsset']);
?>
                                            ...
                                            <table class="table table-centered table-nowrap table-hover mb-0">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-start">
                                                                <img class="me-2 rounded-circle" src="/admin/images/users/avatar-2.jpg" width="40" alt="Generic placeholder image">
                                                                <div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-start">
                                                                <img class="me-2 rounded-circle" src="/admin/images/users/avatar-6.jpg" width="40" alt="Generic placeholder image">
                                                                <div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-start">
                                                                <img class="me-2 rounded-circle" src="/admin/images/users/avatar-3.jpg" width="40" alt="Generic placeholder image">
                                                                <div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-start">
                                                                <img class="me-2 rounded-circle" src="/admin/images/users/avatar-4.jpg" width="40" alt="Generic placeholder image">
                                                                <div>
