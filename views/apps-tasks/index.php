<?php
$this->registerJsFile('/admin/js/pages/demo.tasks.js', ['depends' => 'app\assets\\AdminAsset']);
?>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="d-flex justify-content-between">
                                                            <div id="tooltip-container">
                                                                <img src="/admin/images/users/avatar-9.jpg" alt="image" class="avatar-xs rounded-circle me-1"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="d-flex justify-content-between">
                                                            <div id="tooltip-container1">
                                                                <img src="/admin/images/users/avatar-2.jpg" alt="image" class="avatar-xs rounded-circle me-1"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="d-flex justify-content-between">
                                                            <div id="tooltip-container2">
                                                                <img src="/admin/images/users/avatar-4.jpg" alt="image" class="avatar-xs rounded-circle me-1"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="d-flex justify-content-between">
                                                            <div id="tooltip-container5">
                                                                <img src="/admin/images/users/avatar-7.jpg" alt="image" class="avatar-xs rounded-circle me-1"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="d-flex justify-content-between">
                                                            <div id="tooltip-container8">
                                                                <img src="/admin/images/users/avatar-5.jpg" alt="image" class="avatar-xs rounded-circle me-1"
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="card mb-2 shadow-none border">
                                                    <div class="p-1">
                                                        <div class="row align-items-center">
                                                            <div class="col-auto">
                                                                <img src="/admin/images/projects/project-1.jpg"
