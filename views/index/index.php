                                    ...
                                    <div class="col-sm-6">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h5 class="text-muted fw-normal mt-0" title="客户数量">客户数</h5>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h5 class="text-muted fw-normal mt-0" title="订单数量">订单</h5>
                                ...
                                <div class="card card-h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <h4 class="header-title">预测与实际对比</h4>
                                            <div class="dropdown">
                                    ...
                                    <div class="card-body py-0" data-simplebar style="max-height: 405px;"> 
                                        <div class="timeline-alt py-0">
                                            ...
                                            <div class="timeline-item">
                                                ...
                                                <div class="timeline-item-info">
                                                    <a href="javascript:void(0);" class="text-primary fw-bold mb-1 d-block">Bootstrap市场上的产品</a>
