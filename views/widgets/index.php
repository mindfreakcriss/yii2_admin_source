                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <span class="float-start m-2 me-4">
                                            <img src="/admin/images/users/avatar-2.jpg" style="height: 100px;" alt="" class="rounded-circle img-thumbnail">
                                        </span>
                                        <div class="">
                            ...
                            <div class="col-xl-4">
                                ...
                                <div class="card">
                                    ...
                                    <div class="chat-conversation">
                                        <div class="card-body py-0" data-simplebar style="height: 322px;">
                                            <ul class="conversation-list">
                                                ...
                                                <li class="clearfix odd">
                                                    <div class="chat-avatar">
                                                        <img src="/admin/images/users/avatar-1.jpg" alt="Female">
                                                        <i>10:01</i>
                                                    </div>
                                                    <div class="conversation-text">
                                                        <div class="ctext-wrap">
                                                ...
                                                <li class="clearfix odd">
                                                    <div class="chat-avatar">
                                                        <img src="/admin/images/users/avatar-1.jpg" alt="male">
                                                        <i>10:02</i>
                                                    </div>
                                                    <div class="conversation-text">
                                                        <div class="ctext-wrap">
                                ...
                                <div class="card cta-box bg-primary text-white">
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <img class="my-3" src="/admin/images/report.svg" width="180" alt="Generic placeholder image">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4">
                                <div class="card">
                                    ...
                                    <div class="card-body py-0" data-simplebar style="max-height: 324px;">
                            ...
                            <div class="col-xl-4">
                                <div class="card">
                                    ...
                                    <div class="card-body py-0" data-simplebar style="max-height: 324px; overflow-x: hidden;">
