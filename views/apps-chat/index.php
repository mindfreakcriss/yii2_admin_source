                                                    ...
                                                    <div class="card-body py-0" data-simplebar style="max-height: 562px">
                                                        <a href="javascript:void(0);" class="text-body">
                                                            <div class="d-flex align-items-start mt-1 p-2">
                                                                <img src="/admin/images/users/avatar-2.jpg" class="me-2 rounded-circle" height="48" alt="Brandon Smith" />
                                                        ...
                                                        <a href="javascript:void(0);" class="text-body">
                                                            <div class="d-flex align-items-start bg-light p-2">
                                                                <img src="/admin/images/users/avatar-5.jpg" class="me-2 rounded-circle" height="48" alt="Shreyu N" />
                                                                <div class="w-100 overflow-hidden">
                                                                    <h5 class="mt-0 mb-0 font-14">
                                                        ...
                                                        <a href="javascript:void(0);" class="text-body">
                                                            <div class="d-flex align-items-start mt-1 p-2">
                                                                <img src="/admin/images/users/avatar-7.jpg" class="me-2 rounded-circle" height="48" alt="Maria C" />
                                                                <div class="w-100 overflow-hidden">
                                                                    <h5 class="mt-0 mb-0 font-14">
                                                        ...
                                                        <a href="javascript:void(0);" class="text-body">
                                                            <div class="d-flex align-items-start mt-1 p-2">
                                                                <img src="/admin/images/users/avatar-10.jpg" class="me-2 rounded-circle" height="48" alt="Rhonda D" />
                                                                <div class="w-100 overflow-hidden">
                                                                    <h5 class="mt-0 mb-0 font-14">
                                                        ...
                                                        <a href="javascript:void(0);" class="text-body">
                                                            <div class="d-flex align-items-start mt-1 p-2">
                                                                <img src="/admin/images/users/avatar-3.jpg" class="me-2 rounded-circle" height="48" alt="Michael H" />
                                                                <div class="w-100 overflow-hidden">
                                                                    <h5 class="mt-0 mb-0 font-14">
                                                        ...
                                                        <a href="javascript:void(0);" class="text-body">
                                                            <div class="d-flex align-items-start mt-1 p-2">
                                                                <img src="/admin/images/users/avatar-6.jpg" class="me-2 rounded-circle" height="48" alt="Thomas R" />
                                                                <div class="w-100 overflow-hidden">
                                                                    <h5 class="mt-0 mb-0 font-14">
                                                                        <span class="float-end text-muted font-12">Tue</span>
                                                                        Thomas R
                                                        ...
                                                        <a href="javascript:void(0);" class="text-body">
                                                            <div class="d-flex align-items-start mt-1 p-2">
                                                                <img src="/admin/images/users/avatar-8.jpg" class="me-2 rounded-circle" height="48" alt="Thomas J" />
                                                                <div class="w-100 overflow-hidden">
                                                                    <h5 class="mt-0 mb-0 font-14">
                                                                        <span class="float-end text-muted font-12">Tue</span>
                                                                        Thomas J
                                                        ...
                                                        <a href="javascript:void(0);" class="text-body">
                                                            <div class="d-flex align-items-start mt-1 p-2">
                                                                <img src="/admin/images/users/avatar-1.jpg" class="me-2 rounded-circle" height="48" alt="Ricky J" />
                                                                <div class="w-100 overflow-hidden">
                                                                    <h5 class="mt-0 mb-0 font-14">
                                        ...
                                        <ul class="conversation-list px-3" data-simplebar style="max-height: 538px">
                                            <li class="clearfix">
                                                <div class="chat-avatar">
                                                    <img src="/admin/images/users/avatar-5.jpg" class="rounded" alt="Shreyu N" />
                                                    <i>10:00</i>
                                                </div>
                                            ...
                                            <li class="clearfix odd">
                                                <div class="chat-avatar">
                                                    <img src="/admin/images/users/avatar-1.jpg" class="rounded" alt="dominic" />
                                                    <i>10:01</i>
                                                </div>
                                                <div class="conversation-text">
                                                    <div class="ctext-wrap">
                                            ...
                                            <li class="clearfix">
                                                <div class="chat-avatar">
                                                    <img src="/admin/images/users/avatar-5.jpg" alt="Shreyu N" class="rounded" />
                                                    <i>10:02</i>
                                                </div>
                                                <div class="conversation-text">
                                                    <div class="ctext-wrap">
                                            ...
                                            <li class="clearfix odd">
                                                <div class="chat-avatar">
                                                    <img src="/admin/images/users/avatar-1.jpg" alt="dominic" class="rounded" />
                                                    <i>10:03</i>
                                                </div>
                                                <div class="conversation-text">
                                                    <div class="ctext-wrap">
