<!-- start page title -->
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-4">
                                <a href="apps-projects-add.html" class="btn btn-danger rounded-pill mb-3"><i class="mdi mdi-plus"></i> 创建项目</a>
                            </div>
                            <div class="col-sm-8">
                                <div class="text-sm-end">
                                    ...
                                    <div class="btn-group mb-3 ms-1">
                                        ...
                                        <button type="button" class="btn btn-light">已完成</button>
                                    </div>
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted font-13 my-3">With supporting text below as a natural lead-in to additional contenposuere erat a ante...<a href="javascript:void(0);" class="fw-bold text-muted">查看更多</a>
                                        </p>
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <div class="card-body">
                                        ...
                                        <div class="badge bg-secondary text-light">进行中</div>

                                        <p class="text-muted font-13 my-3">This card has supporting text below as a natural lead-in to additional content is a little bit longer...<a href="javascript:void(0);" class="fw-bold text-muted">查看更多</a>
                                        </p>
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item p-3">
                                            <!-- project progress-->
                                            <p class="mb-2 fw-bold">进度 <span class="float-end">28%</span></p>
                                            <div class="progress progress-sm">
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted font-13 my-3">Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid...<a href="javascript:void(0);" class="fw-bold text-muted">查看更多</a>
                                        </p>
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item p-3">
                                            <!-- project progress-->
                                            <p class="mb-2 fw-bold">进度 <span class="float-end">63%</span></p>
                                            <div class="progress progress-sm">
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted font-13 my-3">Some quick example text to build on the card title and make up the bulk of the card's content...<a href="javascript:void(0);" class="fw-bold text-muted">查看更多</a>
                                        </p>
                                        ...
                                        <div id="tooltip-container3">
                                            <a href="javascript:void(0);" data-bs-container="#tooltip-container3" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme" class="d-inline-block">
                                                <img src="/admin/images/users/avatar-10.jpg" class="rounded-circle avatar-xs" alt="friend">
                                            </a>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <!-- project-thumbnail -->
                                    <img class="card-img-top" src="/admin/images/projects/project-1.jpg" alt="project image cap">
                                    ...
                                    <div class="card-body position-relative">
                                        ...
                                        <div class="mb-3" id="tooltip-container4">
                                            ...
                                            <a href="javascript:void(0);" data-bs-container="#tooltip-container4" data-bs-toggle="tooltip" data-bs-placement="top" title="James Anderson" class="d-inline-block">
                                                <img src="/admin/images/users/avatar-9.jpg" class="rounded-circle avatar-xs" alt="friend">
                                            </a>
                                        </div>

                                        <!-- project progress-->
                                        <p class="mb-2 fw-bold">进度 <span class="float-end">45%</span></p>
                                        <div class="progress progress-sm">
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <!-- project-thumbnail -->
                                    <img class="card-img-top" src="/admin/images/projects/project-2.jpg" alt="project image cap">
                                    <div class="card-img-overlay">
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <!-- project-thumbnail -->
                                    <img class="card-img-top" src="/admin/images/projects/project-3.jpg" alt="project image cap">
                                    <div class="card-img-overlay">
                                        <div class="badge bg-secondary text-light p-1">Ongoing</div>
                                    </div>
                                    ...
                                    <div class="card-body position-relative">
                                        ...
                                        <!-- project progress-->
                                        <p class="mb-2 fw-bold">进度 <span class="float-end">71%</span></p>
                                        <div class="progress progress-sm">
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <!-- project-thumbnail -->
                                    <img class="card-img-top" src="/admin/images/projects/project-4.jpg" alt="project image cap">
                                    <div class="card-img-overlay">
                                        <div class="badge bg-secondary text-light p-1">Ongoing</div>
                                    </div>
                                    ...
                                    <div class="card-body position-relative">
                                        ...
                                        <!-- project progress-->
                                        <p class="mb-2 fw-bold">进度 <span class="float-end">52%</span></p>
                                        <div class="progress progress-sm">
