                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="sizing-images-preview">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <img src="/admin/images/users/avatar-2.jpg" alt="image" class="img-fluid avatar-xs rounded">
                                                        <p>
                                                            <code>.avatar-xs</code>
                                                        </p>
                                                        <img src="/admin/images/users/avatar-3.jpg" alt="image" class="img-fluid avatar-sm rounded mt-2">
                                                        <p class="mb-2 mb-sm-0">
                                                            <code>.avatar-sm</code>
                                                        </p>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <img src="/admin/images/users/avatar-4.jpg" alt="image"
                                                    ...
                                                    <div class="col-md-3">
                                                        <img src="/admin/images/users/avatar-5.jpg" alt="image"
                                                    ...
                                                    <div class="col-md-3">
                                                        <img src="/admin/images/users/avatar-6.jpg" alt="image"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="rounded-images-preview">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <img src="/admin/images/users/avatar-7.jpg" alt="image"
                                                    ...
                                                    <div class="col-md-4">
                                                        <img src="/admin/images/users/avatar-8.jpg" alt="image"
                                                    ...
                                                    <div class="col-md-4">
                                                        <img src="/admin/images/users/avatar-9.jpg" alt="image"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="images-shape-preview">
                                                <div class="row">
                                                    <div class="col-sm-2">
                                                        <img src="/admin/images/small/small-2.jpg" alt="image"
                                                    ...
                                                    <div class="col-sm-2">
                                                        <img src="/admin/images/small/small-3.jpg" alt="image"
