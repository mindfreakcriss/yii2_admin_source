                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="row g-0 align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <img src="/admin/images/small/small-1.jpg" class="card-img" alt="...">
                                        </div> <!-- end col -->
                                    </div> <!-- end row-->
                                </div> <!-- end card -->
                            </div> <!-- end col-->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="row row-cols-1 row-cols-md-3 g-3">
                                    <div class="col">
                                        <div class="card">
                                            <img src="/admin/images/small/small-4.jpg" class="card-img-top" alt="Card image cap">
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            <img src="/admin/images/small/small-1.jpg" class="card-img-top" alt="Card image cap">
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
                                                <p class="card-text">This card has supporting text below as a natural
                                                    lead-in to additional content.</p>
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            <img src="/admin/images/small/small-2.jpg" class="card-img-top" alt="Card image cap">
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
