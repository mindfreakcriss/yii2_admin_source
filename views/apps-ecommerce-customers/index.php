<?php
$this->registerJsFile('/admin/js/pages/demo.customers.js', ['depends' => 'app\assets\\AdminAsset']);
?>
                                            ...
                                            <table class="table table-centered table-striped dt-responsive nowrap w-100" id="products-datatable">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="table-user">
                                                            <img src="/admin/images/users/avatar-4.jpg" alt="table-user" class="me-2 rounded-circle">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-user">
                                                            <img src="/admin/images/users/avatar-3.jpg" alt="table-user" class="me-2 rounded-circle">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-user">
                                                            <img src="/admin/images/users/avatar-1.jpg" alt="table-user" class="me-2 rounded-circle">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-user">
                                                            <img src="/admin/images/users/avatar-5.jpg" alt="table-user" class="me-2 rounded-circle">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-user">
                                                            <img src="/admin/images/users/avatar-6.jpg" alt="table-user" class="me-2 rounded-circle">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-user">
                                                            <img src="/admin/images/users/avatar-7.jpg" alt="table-user" class="me-2 rounded-circle">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-user">
                                                            <img src="/admin/images/users/avatar-8.jpg" alt="table-user" class="me-2 rounded-circle">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-user">
                                                            <img src="/admin/images/users/avatar-9.jpg" alt="table-user" class="me-2 rounded-circle">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-user">
                                                            <img src="/admin/images/users/avatar-10.jpg" alt="table-user" class="me-2 rounded-circle">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-user">
                                                            <img src="/admin/images/users/avatar-2.jpg" alt="table-user" class="me-2 rounded-circle">
