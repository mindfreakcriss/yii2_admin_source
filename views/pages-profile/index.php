<?php 
$this->registerJsFile('/admin/js/pages/demo.profile.js', ['depends' => 'app\assets\AdminAsset']);
?>
<!-- start page title -->
                        <div class="row">
                            <div class="col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <div class="row align-items-center">
                                                    <div class="col-auto">
                                                        <div class="avatar-lg">
                                                            <img src="/admin/images/users/avatar-2.jpg" alt="" class="rounded-circle img-thumbnail">
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div>
                                                            <h4 class="mt-1 mb-1 text-white">Michael Franklin</h4>
                                                            <p class="font-13 text-white-50"> 授权品牌卖家</p>
    
                                                            <ul class="mb-0 list-inline text-light">
                                                                <li class="list-inline-item me-3">
                                                                    <h5 class="mb-1 text-white">$ 25,184</h5>
                                                                    <p class="mb-0 font-13 text-white-50">总收入</p>
                                                                </li>
                                                                <li class="list-inline-item">
                                                                    <h5 class="mb-1 text-white">5482</h5>
                                                                    <p class="mb-0 font-13 text-white-50">订单数量</p>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="text-center mt-sm-0 mt-3 text-sm-end">
                                                    <button type="button" class="btn btn-light">
                                                        <i class="mdi mdi-account-edit me-1"></i> 编辑资料
                                                    </button>
                                                </div>
                                            </div> <!-- end col-->
                                        </div> <!-- end row -->
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title mt-0 mb-3">商家信息</h4>
                                        ...
                                        <div class="text-start">
                                            <p class="text-muted"><strong>全名 :</strong> <span class="ms-2">Michael A. Franklin</span></p>

                                            <p class="text-muted"><strong>手机 :</strong><span class="ms-2">(+12) 123 1234 567</span></p>

                                            <p class="text-muted"><strong>邮箱 :</strong> <span class="ms-2">coderthemes@gmail.com</span></p>

                                            <p class="text-muted"><strong>位置 :</strong> <span class="ms-2">USA</span></p>

                                            <p class="text-muted"><strong>语言 :</strong>
                                                <span class="ms-2"> English, German, Spanish </span>
                                            </p>
                                            <p class="text-muted mb-0" id="tooltip-container"><strong>其他 :</strong>
                                ...
                                <div class="card text-white bg-info overflow-hidden">
                                    <div class="card-body">
                                        <div class="toll-free-box text-center">
                                            <h4> <i class="mdi mdi-deskphone"></i> 免费电话 : 1-234-567-8901</h4>
                                        </div>
                                    </div> <!-- end card-body-->
                                </div> <!-- end card-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title mb-3">消息</h4>
                                        ...
                                        <div class="inbox-widget">
                                            ...
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="/admin/images/users/avatar-6.jpg" class="rounded-circle" alt=""></div>
                            ...
                            <div class="col-xl-8">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title mb-3">订单与收入</h4>
                                        <div dir="ltr">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card tilebox-one">
                                            <div class="card-body">
                                                ...
                                                <h6 class="text-muted text-uppercase mt-0">订单</h6>
                                                <h2 class="m-b-20">1,587</h2>
                                                <span class="badge bg-primary"> +11% </span> <span class="text-muted">较上期</span>
                                            </div> <!-- end card-body-->
                                        </div> <!--end card-->
                                    </div><!-- end col -->
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card tilebox-one">
                                            <div class="card-body">
                                                ...
                                                <h6 class="text-muted text-uppercase mt-0">收入</h6>
                                                <h2 class="m-b-20">$<span>46,782</span></h2>
                                                <span class="badge bg-danger"> -29% </span> <span class="text-muted">较上期</span>
                                            </div> <!-- end card-body-->
                                        </div> <!--end card-->
                                    </div><!-- end col -->
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card tilebox-one">
                                            <div class="card-body">
                                                ...
                                                <h6 class="text-muted text-uppercase mt-0">产品销量</h6>
                                                <h2 class="m-b-20">1,890</h2>
                                                <span class="badge bg-primary"> +89% </span> <span class="text-muted">去年</span>
                                            </div> <!-- end card-body-->
                                        </div> <!--end card-->
                                    </div><!-- end col -->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title mb-3">我的产品</h4>
