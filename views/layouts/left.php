                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarCrm" aria-expanded="false" aria-controls="sidebarCrm" class="side-nav-link">
                                ...
                                <span class="badge bg-danger text-white float-end">新增</span>
                                <span> CRM </span>
                            </a>
                        ...
                        <li class="side-nav-title side-nav-item">自定义</li>
                        ...
                        <li class="side-nav-item">
                            <a href="/landing/index" target="_blank" class="side-nav-link">
                                <i class="uil-globe"></i>
                                <span class="badge bg-secondary text-light float-end">新增</span>
                                <span> 落地页 </span>
                            </a>
                        </li>
                        ...
                        <li class="side-nav-title side-nav-item mt-1">组件</li>
