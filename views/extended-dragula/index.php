                                                        ...
                                                        <div class="bg-dragula p-2 p-lg-4">
                                                            ...
                                                            <div id="company-list-left" class="py-2">
                                                                ...
                                                                <div class="card mb-0 mt-2">
                                                                    <div class="card-body">
                                                                        <div class="d-flex align-items-start">
                                                                            <img src="/admin/images/users/avatar-1.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                                ...
                                                                <div class="card mb-0 mt-2">
                                                                    <div class="card-body">
                                                                        <div class="d-flex align-items-start">
                                                                            <img src="/admin/images/users/avatar-2.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                                            <div class="w-100 overflow-hidden">
                                                                ...
                                                                <div class="card mb-0 mt-2">
                                                                    <div class="card-body">
                                                                        <div class="d-flex align-items-start">
                                                                            <img src="/admin/images/users/avatar-3.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                                            <div class="w-100 overflow-hidden">
                                                            ...
                                                            <div id="company-list-right" class="py-2">
                                                                <div class="card mb-0 mt-2">
                                                                    ...
                                                                    <div class="card-body p-3">
                                                                        <div class="d-flex align-items-start">
                                                                            <img src="/admin/images/users/avatar-4.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                                            <div class="w-100 overflow-hidden">
                                                                ...
                                                                <div class="card mb-0 mt-2">
                                                                    <div class="card-body p-3">
                                                                        <div class="d-flex align-items-start">
                                                                            <img src="/admin/images/users/avatar-5.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                                            <div class="w-100 overflow-hidden">
                                                                ...
                                                                <div class="card mb-0 mt-2">
                                                                    <div class="card-body p-3">
                                                                        <div class="d-flex align-items-start">
                                                                            <img src="/admin/images/users/avatar-6.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                                            <div class="w-100 overflow-hidden">
                                                        ...
                                                        <div class="bg-dragula p-2 p-lg-4">
                                                            ...
                                                            <div id="handle-dragula-left" class="py-2">
                                                                ...
                                                                <div class="card mb-0 mt-2">
                                                                    <div class="card-body">
                                                                        <div class="d-flex align-items-start">
                                                                            <img src="/admin/images/users/avatar-7.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                                            <div class="w-100 overflow-hidden">
                                                                ...
                                                                <div class="card mb-0 mt-2">
                                                                    <div class="card-body">
                                                                        <div class="d-flex align-items-start">
                                                                            <img src="/admin/images/users/avatar-8.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                                            <div class="w-100 overflow-hidden">
                                                                ...
                                                                <div class="card mb-0 mt-2">
                                                                    <div class="card-body">
                                                                        <div class="d-flex align-items-start">
                                                                            <img src="/admin/images/users/avatar-9.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                                            <div class="w-100 overflow-hidden">
                                                        ...
                                                        <div class="bg-dragula p-2 p-lg-4">
                                                            ...
                                                            <div id="handle-dragula-right" class="py-2">
                                                                <div class="card mb-0 mt-2">
                                                                    ...
                                                                    <div class="card-body p-3">
                                                                        <div class="d-flex align-items-start">
                                                                            <img src="/admin/images/users/avatar-10.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                                            <div class="w-100 overflow-hidden">
