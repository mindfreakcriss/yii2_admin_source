...
<head>
        ...
        <!-- third party css -->
        <link href="/admin/css/vendor/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
        <!-- third party css end -->
    ...
    <body class="loading" data-layout-color="light" data-layout="detached" data-rightbar-onstart="true">
                ...
                <div class="leftside-menu leftside-menu-detached">
                    ...
                    <div class="leftbar-user">
                        <a href="javascript: void(0);">
                            <img src="/admin/images/users/avatar-1.jpg" alt="user-image" height="42" class="rounded-circle shadow-sm">
                    ...
                    <div class="help-box help-box-light text-center">
                        ...
                        <img src="/admin/images/help-icon.svg" height="90" alt="Helper Icon Image" />
        ...
        <script src="/admin/js/vendor/jquery-jvectormap-1.2.2.min.js"></script>
        <script src="/admin/js/vendor/jquery-jvectormap-world-mill-en.js"></script>
        <!-- third party js ends -->

        <!-- demo app -->
        <script src="/admin/js/pages/demo.dashboard.js"></script>
        <!-- end demo js-->
