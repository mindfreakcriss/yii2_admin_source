<div class="account-pages pt-2 pt-sm-5 pb-4 pb-sm-5">
                    ...
                    <div class="col-xxl-4 col-lg-5">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <h4 class="text-dark-50 text-center mt-0 fw-bold">免费注册</h4>
                                ...
                                <form action="#">
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="checkbox-signup">我接受 <a href="#" class="text-muted">条款和条件</a></label>
                                        </div>
                                    </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted">已有账户？<a href="pages-login.html" class="text-muted ms-1"><b>登录</b></a></p>
                            </div> <!-- end col-->
                        </div>
                        <!-- end row -->
        ...
        <footer class="footer footer-alt">
            2018 - <script>document.write(new Date().getFullYear())</script> © criss-admin - Coderthemes.com
        </footer>
